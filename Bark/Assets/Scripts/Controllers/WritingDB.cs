...
public static class WritingDB {
	...
	public static Dictionary<string, string> DogDescriptions = new Dictionary<string, string>()
	{
        ...
        {"Beagle", "He seems to be pointing at something!"}
    };

	public static Dictionary<string, string> ItemDescriptions = new Dictionary<string, string>()
	{
		{"Super Potion", "Those purple treats are much better than the blue ones. I'm not sure why though. They certainly taste better. Heals your full health."},
        {"Potent Potion", "Oh boy blue dog treats! I love the color blue, it's my favorite. Much better than orange. Heals a half of your full health."},
        {"Mild Potion", "A box of dog treats, the dogs seem to enjoy it and I bet I will too! Heals 1/4 of your full health."},
        {"Note 0", "It has some smudged text, but this is what I can make out: \"If you want to survive, you'll have to find the key in the forest and unlock this bomb shelter... --------------------- My only wish is that I could save the shelter dogs. Some of them are quite mutated and violent, and I think it's because of ---------------------------------- But the rest seem to be friendly, and --------------------------------------------- Dear son, please rescue as many of the shelter dogs as you can and take refuge in the bomb shelter.\""},
