...
public static class WritingDB {
	...
	{
		{"Super Potion", "Those purple treats smell much better than the blue ones. I'm not sure why though. Heals the full health of the dog with the lowest health."},
        {"Potent Potion", "My favorite color is blue! But where are these treats coming from? Heals half health of the dog with the lowest health."},
        {"Mild Potion", "The dogs are begging for some treats! Heals 1/4 health of the dog with the lowest health."},
